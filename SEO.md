...
- July 27 production delivery check: all 12 HTML routes, `robots.txt`, `sitemap.xml`, the seller record, and both Open Graph images returned HTTPS 200 and matched commit `8438dc9` byte for byte; an unknown route returned 404. The July 27 Mode B copy and image edits are uncommitted local work and are not part of the deployed site.
