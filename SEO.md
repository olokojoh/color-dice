...
- A labeled sponsored section after the introductory content combines one Smartlink and one 300x250 Adsterra banner on each homepage. The Smartlink opens in a new tab and uses `rel="sponsored noopener noreferrer"`. Popunder and Social Bar scripts are limited to the two homepages. None of these placements replaces crawlable copy; trust pages, supporting articles, and the 404 page remain ad-free.
